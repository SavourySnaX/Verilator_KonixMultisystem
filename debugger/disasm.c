...
const char* FetchSymbolValue(unsigned int value, int hexWidth);

void AppendHexValue32(unsigned int value)
{
	AddToOutput(FetchSymbolValue(value,8));
}

void AppendHexValue16(unsigned short value)
{
	AddToOutput(FetchSymbolValue(value,4));
}

void AppendHexValue8(unsigned char value)
{
	AddToOutput(FetchSymbolValue(value,2));
}
