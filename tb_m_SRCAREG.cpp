#include <stdlib.h>
#include "Vm_SRCAREG.h"
#include "verilated.h"
#include "verilated_vcd_c.h"

void SetADDQ(Vm_SRCAREG *tb, uint32_t value)
{
    tb->ADDQ_0=value&1;
    tb->ADDQ_1=(value>>1)&1;
    tb->ADDQ_2=(value>>2)&1;
...
void SetID(Vm_SRCAREG *tb, uint8_t value)
{
    tb->ID_0=value&1;
    tb->ID_1=(value>>1)&1;
    tb->ID_2=(value>>2)&1;
...
int DoNTicks(Vm_SRCAREG *tb, VerilatedVcdC *trace, int ticks, int n)
{
    for (int a=0;a<n;a++)
    {
		trace->dump(ticks*10);
...
int main(int argc, char** argv)
{
    ...
    tb->ADDBACKL=1;
    tb->ADDBLDL=1;
    tb->SRCRDL_0=tb->SRCRDL_1=tb->SRCRDL_2=1;
    tb->LDSAL_0=tb->LDSAL_1=tb->LDSAL_2=1;
    tb->SDASEL=0;       // Selects between SRCREG or ADDQ as output
    tb->UPSLDL=1;
