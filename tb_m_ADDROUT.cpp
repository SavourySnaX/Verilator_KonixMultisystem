#include <stdlib.h>
#include "Vm_ADDROUT.h"
#include "verilated.h"
#include "verilated_vcd_c.h"

void SetSAL(Vm_ADDROUT *tb, uint32_t value)
{
    tb->SAL_0=value&1;
    tb->SAL_1=(value>>1)&1;
    tb->SAL_2=(value>>2)&1;
...
void SetDAL(Vm_ADDROUT *tb, uint32_t value)
{
    tb->DAL_0=value&1;
    tb->DAL_1=(value>>1)&1;
    tb->DAL_2=(value>>2)&1;
...
void SetPCL(Vm_ADDROUT *tb, uint32_t value)
{
    tb->PCL_0=value&1;
    tb->PCL_1=(value>>1)&1;
    tb->PCL_2=(value>>2)&1;
...
int DoNTicks(Vm_ADDROUT *tb, VerilatedVcdC *trace, int ticks, int n)
{
    for (int a=0;a<n;a++)
    {
		trace->dump(ticks*10);
